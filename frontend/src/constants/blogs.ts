...
export const MOCK_BLOGS: BlogPost[] = [
  {
    ...
    content: `
      ...
      <p>Decentralized protocols like FrethiX are stepping in to bridge the trust gap. By using smart contracts as an impartial escrow agent, we ensure that funds are only released when both parties agree on the outcome.</p>
      ...
      <p>As we move towards Web3, the boundary between "work" and "contribution" will blur. FrethiX is at the forefront of this movement, providing the infrastructure for a global, borderless workforce.</p>
    `,
    category: 'Industry',
    date: 'Mar 20, 2026',
    readTime: '5 min read',
  ...
  },
  {
    ...
    content: `
      <p>Winning high-ticket clients in the Web3 space requires more than just technical skills. It requires a verifiable proof of reputation. Here's how you can stand out on FrethiX.</p>
      <h3>1. Leverage Your On-Chain History</h3>
      <p>Clients values freelancers who have a track record. Your FrethiX profile displays your completion rate and total earnings. Make sure these stats are highlighted in your proposals.</p>
  ...
  {
    id: '3',
    title: 'Security First: How FrethiX Protects Funds',
    excerpt: 'Learn about the multi-layered security approach we take to ensure your ETH is always safe in our escrow.',
    content: `
      <p>Security is not a feature; it's the foundation of FrethiX. Since our launch, we've focused on creating the most secure escrow environment for the decentralized workforce.</p>
